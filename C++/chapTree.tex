...
\subsubsection{相關題目}
\begindot
\item Binary Tree Level Order Traversal II，見 \S \ref{sec:binary-tree-tevel-order-traversal-ii}
...
\subsubsection{分析}
在上一題（見\S \ref{sec:binary-tree-tevel-order-traversal}）的基礎上，\fn{reverse()}一下即可。
...
\subsubsection{相關題目}
\begindot
\item Binary Tree Level Order Traversal，見 \S \ref{sec:binary-tree-tevel-order-traversal}
\item Binary Tree Zigzag Level Order Traversal，見 \S \ref{sec:binary-tree-zigzag-level-order-traversal}
\myenddot
